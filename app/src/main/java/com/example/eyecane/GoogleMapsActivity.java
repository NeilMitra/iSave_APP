...

{
    ...
    {
        String hospital = "hospital", school = "school", restaurant = "restaurants";
        ...
        switch (v.getId())
        {
            case R.id.search_address:
                ...
                {
                    Toast.makeText(this, "Please state where you would like to go...", Toast.LENGTH_SHORT).show();
                }
                break;
    ...
    private String getUrl(double latitide, double longitude, String nearbyPlace)
    {
        ...
        googleURL.append("&key=" + "AIzaSyCWr1ubhrWmFy3hDpRPqEj3PpLueatMFSA"); // ******* HERE IS THE LINE THAT NEEDS FIXING BECAUSE OF API
